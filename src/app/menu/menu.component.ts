  ...
  ngOnInit() {
    ...
    this.displayMenu = this.menuItems = [
      ...
      },
      {
        type: "Main Entrees",
        name: "Mixed Grill",
        descrption: "Ground Beef, chickenm kabob and lamb kabob served with rice & salad",
        img: "assets/images/project/04.jpg",
        price: 23.95
      },
      {
      ...
      {
        type: "Main Entrees",
        name: "Chicked and Beef Combo",
        descrption: "Grilled chicken kabob with beef kabob served with rice, grilled tomato & slad",
        img: "assets/images/project/04.jpg",
        price: 20.95
      },
      {
